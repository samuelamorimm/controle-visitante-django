    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horario_saida', models.DateField(blank=True, null=True, verbose_name='Horário de saída na portaria')),
                ('morador_responsavel', models.CharField(max_length=200, verbose_name='Nome do morado responsável')),
